...
// finance statistics section
  ...
  maxCurrencySupply: {
    ...
    help: <i>The maximum number of coins that can be created, including inflation and coins in possession of the development team. </i>
  },
  circulatingSupply: {
    legend: 'Circulating supply',
    help: <i>The number of coins in existence available to the public. </i>
  },
  totalEvaluation: {
