...
const FundKeeper = t.enums({
  ...
  multiSigContract: 'Multi-sig wallet',
  unknown: 'Unknown'
});
...
const IcoPublicTypeDefObj = {
  ...
  instantExchangeLink: t.maybe(t.String),
  ...
  circulatingSupply: t.maybe(t.String),
...
const IcoTypeDef = _.assign(IcoPublicTypeDefObj, IcoAdminTypeDefObj);
const IcoPublicTypeDef = IcoPublicTypeDefObj;
let ChangeRequestTypeDefObj = _.cloneDeep(IcoPublicTypeDef);
ChangeRequestTypeDefObj = _.mapKeys(ChangeRequestTypeDefObj, (value, key) => {
  return key + '_old';
});
ChangeRequestTypeDefObj = _.assign(ChangeRequestTypeDefObj, IcoPublicTypeDefObj);

const IcoType = t.struct(IcoTypeDef);
const IcoPublicType = t.struct(IcoPublicTypeDefObj);
const ChangeRequestType = t.struct(ChangeRequestTypeDefObj);

export {IcoType, IcoPublicType, IcoTypeDef, IcoPublicTypeDef, IcoEvent, FundKeeper, ProjectStatus, ChangeRequestType};
