...
export default class CountsCompute {
  ...
  static compute() {
    ...
    const postProcessCounts = (countsObj) => {
      ...
      obj['scam-or-suspicious'] = obj['scam-or-suspicious'] || 0;
      obj['without-date'] = obj['without-date'] || 0;
    ...
    const output = { published: postProcessCounts(publishedCounts), concepts: postProcessCounts(conceptCounts) };
    console.log(output);
